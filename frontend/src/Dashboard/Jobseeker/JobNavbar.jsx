                ...
                <ul className="navbar-nav ms-3">
                    ...
                    <ul className="dropdown-menu shadow border-0">
                        ...
                        <li><Link className="dropdown-item" href="#">
                            <div>
                            <div className="small text-gray-500">December 5, 2024</div>
...
// `Hi i am creating a job portal mern project i have sreated user model and controller for register and login according to role selected.And created specific dashboard for both jobseeker and recruiter now i want that when person login show the data of that person according to his userId because there can be multiple jobseeker and recruiter. In frontend i have used privateroute to protect redirecting without login. if you want i can share you my models`