        ...
        try {
            ...
            const response = await fetch(`${API_URL}/api/jobs`, {
                ...
                headers: {
                  ...
                  'Authorization': `Bearer ${token}`, // Make sure this is being sent correctly
                },
            ...
            if (response.ok) {
                ...
                console.log(result.data); // Log the job data (including `postedBy`)
                setAlert({
                ...
                setAlert({
                    message: errorData.message || 'Error posting job',
                    type: 'danger',
                });
